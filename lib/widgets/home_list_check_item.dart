...
class HomeListCheckThisItem extends StatelessWidget {
  const HomeListCheckThisItem({super.key});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetCheckThisitemBloc>().add(GetCheckThisitemEvent.getCheckThisItem());
    });
    return BlocBuilder<GetCheckThisitemBloc, GetCheckThisitemState>(
