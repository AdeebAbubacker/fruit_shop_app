...
class HomeListEveryDayEssential extends StatelessWidget {
  const HomeListEveryDayEssential({super.key});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context
          .read<GetEveryDayEssentialBloc>()
          .add(GetEveryDayEssentialEvent.getEveryDayEssential());
    });
    return BlocBuilder<GetEveryDayEssentialBloc, GetEveryDayEssentialState>(
