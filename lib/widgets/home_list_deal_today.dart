...
class HomeListDealToday extends StatelessWidget {
  const HomeListDealToday({super.key});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetDealofTheDayBloc>().add(GetDealofTheDayEvent.getDealofTheDay());
    });
